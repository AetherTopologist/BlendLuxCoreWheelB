...
set CMAKE_OPTS=-G %CMAKE_GENERATOR% %CMAKE_PLATFORM% %CMAKE_TOOLSET% ^
  -DCMAKE_INCLUDE_PATH="%INCLUDE_DIR%" ^
  -DCMAKE_LIBRARY_PATH="%LIB_DIR%" ^
  -DPYTHON_LIBRARY="%LIB_DIR%" ^
  -DPYTHON_V=%PYTHON_VERSION% ^
  -DPYTHON_INCLUDE_DIR="%INCLUDE_DIR%\Python%PYTHON_VERSION%" ^
